...
outputParameters = [{'parameter': 'waterLevel', 'value': 50, 'targetURI': 'urn:ngsi-ld:Valve:V1'}, {'parameter': 'initialQuality', 'value': 2, 'targetURI': 'urn:ngsi-ld:Tank:T1'}]
attribute = "outputParameters"
