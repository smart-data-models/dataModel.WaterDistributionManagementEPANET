...
#### Verzweigung NGSI-v2-Schlüsselwerte Beispiel  
Hier ist ein Beispiel für eine Junction im JSON-LD-Format als Key-Values. Dies ist kompatibel mit NGSI-v2 bei Verwendung von `options=keyValues` und gibt die Kontextdaten einer einzelnen Entität zurück.  
...
Hier ist ein Beispiel für eine Junction im JSON-LD-Format wie normalisiert. Dies ist kompatibel mit NGSI-v2, wenn keine Optionen verwendet werden, und liefert die Kontextdaten einer einzelnen Entität.  
...
```  
#### Verzweigung NGSI-LD-Schlüsselwerte Beispiel  
...
Hier ist ein Beispiel für eine Junction im JSON-LD-Format wie normalisiert. Dies ist kompatibel mit NGSI-LD, wenn keine Optionen verwendet werden, und liefert die Kontextdaten einer einzelnen Entität.  
